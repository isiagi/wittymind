      ...
      <div className="flex px-5 justify-center flex-wrap w-full">
        ...
        <div className="md:max-w-[70%]">
          <div className="flex gap-2 text-center flex-wrap justify-end">
            <div className="md:max-w-[30%] flex flex-col justify-center items-center border-[1px] px-2 py-5 border-[#876120]">
              <FaRegHandshake className="text-3xl text-[#876120]" />
              <h2 className="py-2 font-medium text-xl text-[#205386]">
            ...
            <div className="md:max-w-[30%] flex flex-col justify-center items-center border-[1px] px-2 py-5 border-[#876120]">
              ...
              <h2 className="py-2 text-xl text-[#205386]">
